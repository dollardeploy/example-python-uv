...
## Prerequisites
- Python 3.13+
- uv will be installed automatically during build

## Quick Start

### Clone Repository
```bash
git clone https://github.com/yourusername/example-python-uv/
...
- **Run Command**: `uv run uvicorn main:app --host 0.0.0.0 --port 8000`
- **Port**: `8000`
